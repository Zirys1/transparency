...
% In Rotterdam: Of these, 43\% were female, the average age was 22, and the majority (84\%) studied economics. The experiment took place in the Econ-lab of the Erasmus School of Economics. 
%% MENTION TESTS of differences between the samples (covariates). Later state if outcomes also differ, control for that)
