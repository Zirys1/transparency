...
su comp1 if comp1 < .05 // summarize statistics only when p-value below 5% threshold // Control vs. Default
su comp2 if comp2 < .05 // Control vs. Default+Information			(Finding 1)
su comp3 if comp3 < .05 // Control vs. Default+Purpose				(Finding 1)
su comp4 if comp4 < .05 // Control vs. Default+Information+Purpose	(Finding 1)

su comp6 if comp6 < .05 // Default vs. Default+Purpose				(Finding 3)
su comp7 if comp7 < .05 // Default+Info vs. Default+Purpose vs. Default+Info+Purpose	(Finding 4)

su comp5 if comp5 < .05 // Default vs. Default+Information			(Finding 2)


/* Dividing the outcome by the number of simulation draws gives the power. 
For Default vs. Default+Information
